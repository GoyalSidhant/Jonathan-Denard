          ...
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("Log in with email address", style: TextStyle(color: Color(0xffef4f4e) , fontSize: 25 , fontWeight: FontWeight.bold)),
                  SizedBox(height:10),
                  Text("Let's get started!" , textAlign: TextAlign.left , style: TextStyle(color: Colors.grey , fontSize: 15  , )),
